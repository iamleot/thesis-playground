...
```
$ docker run --detach --publish 4566:5000 --volume $PWD/config/amis.json:/amis.json --env MOTO_AMIS_PATH=/amis.json --env MOTO_IAM_LOAD_MANAGED_POLICIES=true --rm motoserver/moto:5.0.20
